...
If an unsolicited LST arrives from the network, the receiving RUDP endpoint can tell the user that the connection is closing. The connection is aborted and the user is told.
